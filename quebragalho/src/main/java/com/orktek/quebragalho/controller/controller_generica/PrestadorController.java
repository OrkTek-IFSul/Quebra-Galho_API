...
public class PrestadorController {
    ...
    // * GET /api/prestadores
    // */
    // @Operation(summary = "Lista todos os prestadores", description = "Retorna uma
    // lista de todos os prestadores cadastrados.")
    // @ApiResponses({
    // @ApiResponse(responseCode = "200", description = "Lista de prestadores
    ...
    // */
    // @GetMapping("/{id}")
    // @Operation(summary = "Busca prestador por ID", description = "Retorna os
    // detalhes de um prestador específico pelo ID.")
    // @ApiResponses({
    // @ApiResponse(responseCode = "200", description = "Prestador encontrado com
    // sucesso"),
    ...
    // // */
    // // @Operation(summary = "Cria novo prestador", description = "Cria um novo
    // prestador associado a um usuário.")
    // // @ApiResponses({
    // // @ApiResponse(responseCode = "201", description = "Prestador criado com
    // sucesso"),
    ...
    // // @Parameter(description = "ID do usuário ao qual o prestador será
    // associado", required = true) @PathVariable Long usuarioId,
    ...
    // // */
    // // @Operation(summary = "Atualiza dados do prestador", description =
    // "Atualiza as informações de um prestador existente.")
    // // @ApiResponses({
    // // @ApiResponse(responseCode = "200", description = "Prestador atualizado com
    // sucesso"),
    // // @ApiResponse(responseCode = "404", description = "Prestador não
    // encontrado")
    // // })
    // // @PutMapping("/{id}")
    // // public ResponseEntity<Prestador> atualizarPrestador(
    // // @Parameter(description = "ID do prestador a ser atualizado", required =
    ...
    // */
    // @Operation(summary = "Remove um prestador", description = "Remove um
    // prestador pelo ID.")
    // @ApiResponses({
    // @ApiResponse(responseCode = "204", description = "Prestador removido com
    // sucesso"),
    // @ApiResponse(responseCode = "404", description = "Prestador não encontrado")
    // })
    // @DeleteMapping("/{id}")
